			...
			<section class="card">
				...
				<div class="card-block">
					...
					<table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tr>
							<!-- <td><?php echo $no;?></td> -->
							<td><a href="produk_detail_v2.php?idproduk=<?php echo $id_produk?>"><?php echo $id_produk;?></a></td>
							...
							<td>
								<?php if ($foto2!='' && file_exists("$foto2")){?>
									<img src="<?php echo $foto2?>" style="width: 200px;">
								<?php } ?>
							</td>
							<td>
								<?php if ($foto3!='' && file_exists("$foto3")){?>
						...
						<?php } else { ?>
						<tr>
							<td class="text-center" colspan="10"><a href="produk_detail_v2.php?idproduk=<?php echo $id?>">Gambar tidak ditemukan!</a></td>
						</tr>
						<?php } ?>
						</tbody>
					</table>
