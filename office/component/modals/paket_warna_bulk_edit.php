...
?>
<div class="modal fade" id="produkWarnaBulkEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="form1" name="form1" method="post" action="api_proses_v2.php" enctype="multipart/form-data">
									<input type="hidden" name="jenis" value="produk_warna_edit_bulk">	
								    <div class="form-group row">
										<label class="col-sm-2 form-control-label">Download Template</label>
										<div class="col-sm-10">
											<a href="template/template_update_image_warna.xls" download="template_update_image_warna.xls">
