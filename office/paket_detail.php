...
<body class="with-side-menu control-panel control-panel-compact">
	...
	$h="SELECT nama_paket from paket_order where id='$id'";
	$qh=mysqli_query($link,$h);  
	list($nama_paket)=mysqli_fetch_array($qh);   
	...
	<div class="page-content">
			...
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h2>Paket produk <?php echo $nama_paket;?></h2>
			...
			<?php 
			   include "paket_detail_entry.php";
			   include "paket_detail_edit.php"; 
			?>
			<section class="card">
				...
				<div class="card-block">
					...
					<table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
						...
						$grand_qty=0;
						$grand_subtotal=0;
						while(list($id_paket,$barcode,$nama_produk,$ukuran,$warna,$disc_conf,$qty,$harga,$diskon,$netto)=mysqli_fetch_array($query)){
							$no++;
							// if($status==1) {
							// 	$text_status="aktif";
							// } else {
						...
						<tr>
							...
							<td>
								...
								data-id="<?php echo $id_paket."-".$barcode;?>"><i class="fa fa-edit"></i></a>
							</td>
						</tr>
						<?php 
						   $grand_qty+=$qty;
	...
	<script type="text/javascript">
        $(document).ready(function(){
	        $('#modalEdit').on('show.bs.modal', function (e) {
	            ...
	            $.ajax({
	                type : 'POST',
	                url :  'paket_detail_edit_fletch.php',
					cache: false,
	                data :  'id='+ idx,
