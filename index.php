      ...
      <div class="row pt-4">
        ...
        <div class="col-md-4 pt-2">
          <a href="category.php?cate=<?php echo $id;?>">
            <div class="card">
              <img class="card-img-top" src="assets/images/<?php echo $images;?>" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title"><?php echo $nama_kategori?></h5>
                <p class="card-text">For Your All Activity</p>
              </div>
            </div>
            </a>
        </div>
          ...
          <a href="detail_produk.php?idp=<?php echo $id?>">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="harga card-text"><?php echo number_format($harga); ?></p>
              </div>
            </div>
          </a>
        </div>
