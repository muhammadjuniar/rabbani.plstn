				...
				<div id="mob-produk" class="col detail-p">
					...
					<div id="size_choise">
							...
							<div class="button" >
								...
								<label class="btn btn-outline-secondary" for="<?php echo $ukuran;?>"><?php echo $ukuran; ?></label>
							</div>
							<?php } ?>
					...
					?>
							<div class="button" >
								...
								<label class="btn btn-outline-secondary" style="background-color:<?php echo $warna;?>;width:32px;height:32px;border:1px solid #ccc;margin-top:5px;" for="<?php echo $warna;?>"></label>
							</div>
